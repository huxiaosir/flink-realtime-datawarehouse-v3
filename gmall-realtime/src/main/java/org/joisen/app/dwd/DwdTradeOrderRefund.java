...
//        System.setProperty("HADOOP_USER_NAME", "joisen");
        ...
        // TODO 3. 从 Kafka 读取 topic_db_0105 数据，封装为 Flink SQL 表
        tableEnv.executeSql("create table topic_db(" +
                ...
                "`ts` string " +
                ")" + MyKafkaUtil.getKafkaDDL("topic_db_0105", "dwd_trade_order_refund_0105"));
        ...
        tableEnv.executeSql("create table dwd_trade_order_refund( " +
                ...
                ")" + MyKafkaUtil.getKafkaSinkDDL("dwd_trade_order_refund_0105"));
