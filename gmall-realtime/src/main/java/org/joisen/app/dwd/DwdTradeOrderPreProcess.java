...
//        System.setProperty("HADOOP_USER_NAME", "joisen");
        ...
        // todo 2. 创建 topic_db_0105 表
        tableEnv.executeSql(MyKafkaUtil.getTopicDb_0105("order_pre_process_0105"));
        ...
        Table orderDetailTable = tableEnv.sqlQuery("select " +
                ...
                "and `type` = 'insert'"); // 使用mock造数据时会产生delete操作，过滤数据时过滤掉delete操作的数据
        tableEnv.createTemporaryView("order_detail_table", orderDetailTable);
        // 转换为流并打印测试
//        tableEnv.toAppendStream(orderDetailTable, Row.class).print("orderDetailTable>>>>>");
...
//        tableEnv.toAppendStream(orderInfoTable, Row.class).print("orderInfoTable>>>>>");
        ...
        // 转换为流并打印测试
//        tableEnv.toAppendStream(orderActivityTable, Row.class).print("orderActivityTable>>>>>");
        ...
        // 转换为流并打印测试
//        tableEnv.toAppendStream(orderCouponTable, Row.class).print("orderCouponTable>>>>>");
