...
import org.joisen.bean.TrafficPageViewBean;
...
//        System.setProperty("HADOOP_USER_NAME", "joisen");
        ...
        // todo 2. 读取三个主题的数据创建流
        String uvTopic = "dwd_traffic_unique_visitor_detail_0105";
        String ujdTopic = "dwd_traffic_user_jump_detail_0105";
        String topic = "dwd_traffic_page_log_0105";
        String groupId = "vccharisnew_pageview_window_0105";
...
//        });
        ...
        SingleOutputStreamOperator<TrafficPageViewBean> resultDS = windowedStream.reduce(new ReduceFunction<TrafficPageViewBean>() {
            ...
            @Override // 再用windowFunction做进一步操作
            public void apply(Tuple4<String, String, String, String> stringStringStringStringTuple4, TimeWindow window, Iterable<TrafficPageViewBean> input, Collector<TrafficPageViewBean> out) throws Exception {
                // 获取数据
